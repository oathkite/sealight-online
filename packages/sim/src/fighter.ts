import type { Affix, Equipment } from "./items";
...
/** 身につけた装備の特性 */
export const affixesOf = (weapon: Equipment | null, armor: Equipment | null): readonly Affix[] =>
  [weapon?.affix, armor?.affix].filter((a): a is Affix => a !== null && a !== undefined);
