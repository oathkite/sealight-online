import type { ClothSpec, Vec3 } from "@sealight/engine";
import type { PatternName } from "../materials";
...
/** 置き物に下げる布（垂れ幕や旗）。世界の位置で、留める辺と広がる向きを決める */
export type ClothAnchor = { readonly spec: ClothSpec; readonly color: ColorName; readonly pattern: PatternName };

/** 置き物を作ったときに、ゲーム側で使う目印（灯りの位置、煙の出る位置、布） */
