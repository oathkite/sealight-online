/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 23eb81671f25c6e3c4327b0b63aa7286)
// Runtime types generated with workerd@1.20260921.1 2026-08-15
interface __BaseEnv_Env {
	LAMP_DURATION_MS: "1500000";
	LAMP_TIMER: DurableObjectNamespace<import("./src/index").LampTimer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LampTimer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LAMP_DURATION_MS">> {}
}
